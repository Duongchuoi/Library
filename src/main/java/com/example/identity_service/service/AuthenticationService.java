...
import com.example.identity_service.respository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private String buildScope(User user) {
        ...
        Set<String> revokedPermissions = user.getRevokedPermissionNames();
            ...
            user.getRoles().forEach(role -> {
                ...
                if (!CollectionUtils.isEmpty(role.getPermissions())) {
                    role.getPermissions().forEach(permission -> {
                        if (!revokedPermissions.contains(permission.getName())) {
